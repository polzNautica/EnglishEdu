          ...
          <div class="table-responsive text-nowrap" style="border-radius: 3px;">
            <table class="table table-striped">
              ...
              <tbody class="table-border-bottom-0">
                ...
                @if($users->isEmpty())
                <tr>
                  <td colspan="100" class="text-center">Users Data Not Found!</td>
                </tr>
                @endif
              </tbody>
            </table>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col mb-3">
              ...
              <input type="text" id="edit_nama_lengkap_user" name="name" value="{{ old('name') }}" class="form-control @if(session('validationErrors')) @foreach (session('validationErrors')['name'] ?? [] as $errorMessage) is-invalid @endforeach @endif" placeholder="Enter user full name" autocomplete="off" required>
