...
<div class="card">
  <div class="card-body">
    <div class="d-flex justify-content-between mb-3">
      <button type="button" onclick="window.location.href='/admin/laporan/{{ $dataquiz->slug }}'" class="btn btn-primary btn-sm"><i class='bx bx-left-arrow-alt bx-xs' style="margin-bottom: 3px;"></i>&nbsp;Back</button>
      <div style="margin-top: 3px;"><i class='bx bx-history bx-spin text-primary mb-1' data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="auto" title="Quiz Submission Date"></i>&nbsp;{{ $dataresult->created_at->locale('en')->isoFormat('D MMMM YYYY | H:mm') }}</div>
    </div>
