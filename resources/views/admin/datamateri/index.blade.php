      ...
      <div class="card-header d-flex align-items-center justify-content-between" style="margin-bottom: -0.7rem;">
        <div class="justify-content-start">
          <button type="button" class="btn btn-xs btn-dark fw-bold p-2 buttonAddMateri" data-bs-toggle="modal" data-bs-target="#formModalAdminMateri">
            <i class='bx bx-book-content fs-6'></i>&nbsp;ADD NEW LESSON
          </button>
        </div>
        <div class="justify-content-end">
          <form action="/admin/data-materi/search">
            <div class="input-group">
              <input type="search" class="form-control" name="q" id="search" style="border: 1px solid #d9dee3;" placeholder="Search Lesson Data..." autocomplete="off" />
            </div>
          </form>
        </div>
      </div>
              ...
              <tbody class="table-border-bottom-0">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    <button type="button" class="btn btn-icon btn-danger btn-sm buttonDeleteMateri" data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="auto" title="Delete Lesson" data-code-materi="{{ encrypt($materi->id) }}" data-title-materi="{{ $materi->title }}">
...
<div id="errorModalAddMateri" data-error-title="@error('title') {{ $message }} @enderror" data-error-image="@error('image') {{ $message }} @enderror" data-error-audio="@error('audio') {{ $message }} @enderror" data-error-category="@error('category') {{ $message }} @enderror" data-error-text="@error('text') {{ $message }} @enderror" data-error-video="@error('video') {{ $message }} @enderror" data-error-link="@error('link') {{ $message }} @enderror"></div>
<!-- Modal Add Materi-->
    ...
    <form action="" method="post" class="modalAdminMateri" enctype="multipart/form-data">
      ...
      <div class="modal-content">
        <div class="modal-header d-flex justify-content-between">
          <h5 class="modal-title text-primary fw-bold">Add New Lesson&nbsp;<i class='bx bx-book-content fs-5' style="margin-bottom: 1px;"></i></h5>
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col mb-3">
              ...
              <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Lesson Title" autocomplete="off" required>
              @error('title')
          ...
          <div class="row">
            <div class="col mb-3">
              ...
              <div id="textQuill" style="height: 50vh;">{{ old('text') }}</div>
...
<div id="errorModalEditMateri" data-error-edit-title="@error('titleEdit') {{ $message }} @enderror" data-error-edit-image="@error('imageEdit') {{ $message }} @enderror" data-error-edit-audio="@error('audioEdit') {{ $message }} @enderror" data-error-edit-category="@error('categoryEdit') {{ $message }} @enderror" data-error-edit-text="@error('textEdit') {{ $message }} @enderror" data-error-edit-video="@error('videoEdit') {{ $message }} @enderror" data-error-edit-link="@error('linkEdit') {{ $message }} @enderror"></div>
<!-- Modal Edit Lesson-->
<div class="modal fade" id="formEditModalAdminMateri" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="/admin/data-materi/update" method="post" class="modalAdminMateri" enctype="multipart/form-data">
      ...
      <div class="modal-content">
        <div class="modal-header d-flex justify-content-between">
          <h5 class="modal-title text-primary fw-bold">Edit Lesson&nbsp;<i class='bx bx-joystick fs-5' style="margin-bottom: 1px;"></i></h5>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col mb-3">
              ...
              <input type="text" id="titleEdit" name="titleEdit" value="{{ old('titleEdit') }}" class="form-control @error('titleEdit') is-invalid @enderror" autocomplete="off" placeholder="Enter Lesson Title" required>
              @error('titleEdit')
              <div class="invalid-feedback" style="margin-bottom: -3px;">
                {{ $message }}
              </div>
          ...
          <div class="row">
            <div class="col mb-3">
              ...
              <div id="quill-modal-wrapper">
                <div id="textEditQuill" style="height: 50vh;">{{ old('textEdit') }}</div>
              </div>
...
function initModalEditor() {
  ...
  wrapper.innerHTML = '<div id="textEditQuill" style="height: 50vh;"></div>';
