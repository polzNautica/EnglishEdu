...
<div class="card mb-4">
    ...
    <div class="d-flex justify-content-between">
      <div>
        <button type="button" class="btn btn-xs btn-dark fw-bold p-2" data-bs-toggle="modal" data-bs-target="#formModalAddTopic">
          <i class='bx bx-message-dots fs-6'></i>&nbsp;&nbsp;ADD THREAD
        </button>
      </div>
      <div>
        <form action="/view/discuss/search">
          <div class="input-group">
            <input type="search" class="form-control" name="q" id="search" style="border: 1px solid #d9dee3; width:300px" placeholder="Search Topic of Discussions..." autocomplete="off" />
          </div>
        </form>
      </div>
    </div>
  ...
  <div class="card-body">
        ...
        <div class="card h-100 shadow-none border">
            ...
            <div class="d-flex">
              ...
              <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-1">
                <div class="me-2">
                  ...
                  <small class="text-muted">Posted {{ $thread->created_at->locale('en')->diffForHumans() }}</small>
                </div>
          ...
          <div class="card-body">
            ...
            <div class="d-flex mt-4 align-items-center justify-content-between">
              ...
              <div>
                <a style="font-size: 0.875rem;" href="/view/discuss/thread/{{$thread->id}}">View Details <i class='bx bx-right-arrow-alt mb-1'></i></a>
              </div>
            </div>
          </div>
        </div>
    ...
    @if($threads->isEmpty())
    <span class="d-flex justify-content-center mb-2"><i class='bx bx-info-circle fs-5' style="margin-top: 3px;"></i>&nbsp;Data not found!</span>
    @endif
        ...
        <div class="modal-body">
          <div class="row">
            <div class="col mb-3">
              ...
              <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control @error('title') is-invalid @enderror" placeholder="Enter your thread title" autocomplete="off" required>
              @error('title')
          ...
          <div class="row">
            <div class="col">
              ...
              <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" autocomplete="off" placeholder="Enter your thread description" rows="4" required>{{ old('content') }}</textarea>
              @error('content')
              <div class="invalid-feedback" style="margin-bottom: -3px;">
                {{ $message }}
              </div>
